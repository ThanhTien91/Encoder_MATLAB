...
% DESCRIPTION: Standardized error metrics computation for position/
...
if length(true_signal) ~= length(est_signal)
    error('ERROR: Vector length mismatch!');
end
...
% ==========================================================================
% 3. DELAY ESTIMATION (Cross-Correlation)
% ==========================================================================

% Only for Dynamic Signals (Variance > Threshold)
if var(true_signal) > 1e-6
    ...
    % Constant Velocity: Delay Undefined
